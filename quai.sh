...
check_version(){
    ...
    echo -e "\033[1;32m恭喜老板，当前go-quai节点版本是v0.39.0，无需升级，比特猎人伴您走向财富自由！！！！\033[0m"
	else
       echo -e "\033[1;31m当前go-quai节点低于版本v0.39.0版本，请立刻执行选项8进行一键升级，否则无法挖矿！！！！\033[0m"
	fi
